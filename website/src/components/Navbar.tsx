      ...
      <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''} ${mobileMenuOpen ? 'navbar--open' : ''}`}>
        <div className="container navbar-container" style={{ paddingLeft: 0, paddingRight: 0 }}>
          ...
          <div className="nav-actions">
            <a href="https://github.com/kwakhare5/tonal" target="_blank" rel="noopener noreferrer" className="login-btn github-nav-btn" style={{ fontSize: '13px', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
